...
int main()
{
	...
	// i2c
	if(access("/dev/bone/i2c/0", F_OK ) != 0){
		printf("ERROR:  i2c1 driver not loaded\n");
	} else printf("PASSED: i2c1\n");
	if(access("/dev/bone/i2c/2", F_OK ) != 0){
